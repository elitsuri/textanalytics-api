...
app = FastAPI(
    title="TextAnalytics API",
    description="NLP service for sentiment analysis, entity extraction, and summarization",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "TextAnalytics API"}
